              ...
              {featuresData.map(({ color, title, icon, description }) => (
                  ...
                  >
                    <CardBody className="flex flex-col items-center justify-center">
                      <div
                          className="mb-4 flex items-center justify-center bg-white rounded-full w-12 h-12"
                      >
                        <img
                            src={icon}
                            alt="icon"
                      ...
                      <p className="text-center text-sm text-gray-600 font-light text-gray-400">{description}</p>
                      {/* description의 글자 스타일 수정 */}
                    </CardBody>
                  </Card>
              ))}
            </div>
